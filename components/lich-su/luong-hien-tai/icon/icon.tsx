...
export function IconLuong({
  ...
  return (
    <div className={`${styles.body} ${styles.bodyWhite}`}>
      ...
      <div className={styles.text}>
        <p
          className={`${styles.textTop} ${styles.textTopNormal}`}
          style={{ color: `${colorText}` }}
        >
          {textTop}
        </p>
        <p className={`${styles.textBottom} ${styles.textBottomNormal}`}>
          {textBottom}
        </p>
      </div>
    </div>
