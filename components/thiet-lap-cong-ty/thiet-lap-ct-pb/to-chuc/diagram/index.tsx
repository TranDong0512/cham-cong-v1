...
import { Typography, Button, Input, Tooltip, Divider } from "antd";
...
export default function Diagram() {
    ...
    const openNotificationWithIcon = (type: NotificationType, mess) => {
        api[type]({
            message: type,
            description: mess,
        });
    ...
    function Node({
        ...
        return (
            <div ref={drop}>
                ...
                >
                    <div className="flex flex-end mb-8 h-30px ">
                        {showEdit && level !== 0 ? (
                            <Tooltip title="Sửa">
                                <div
                        ...
                        {level !== 0 ? (
                            <div>
                                ...
                                <div>
                                    <Text>
                                        Lãnh đạo:{" "}
                                        {manager ? manager : "Chưa cập nhập"}
                                    </Text>
                                </div>
                                <div>
                                    <Text>
                                        Số nhân viên:{" "}
                                        {ep_num ? ep_num : "Chưa cập nhập"}
                                    </Text>
                                </div>
                            </div>
                        ) : (
