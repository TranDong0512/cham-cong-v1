...
import styles from "./pc.365.module.css";
...
export const PC365: React.FC = () => {
  const listpc365 = [
    {
      title:
        "Tại Trang chủ, chọn mục chấm công làm việc nhấn vào nút màu xanh có mã QR",
      clicked: true,
      img: "/pc1.png",
    },
    {
  ...
  const [listStep, setListStep] = useState(listpc365);
    ...
    <div className={styles.main}>
      ...
      <Row gutter={{ sm: 32, xs: 32 }} className={styles.options}>
        <Col xxl={4} xl={7} sm={8} xs={24}>
          <Link href="/cham-cong-bang-QR/cham-cong-365">
        ...
        <Col xxl={4} xl={7} sm={8} xs={24}>
          <Link href="/cham-cong-bang-QR/chat-365">
        ...
        <Col xxl={4} xl={7} sm={8} xs={24}>
          <Link href="/cham-cong-bang-QR/pc-365">
            <div className={styles.pc365} style={{ background: "#FFC460" }}>
              <div className={styles.iconlogo}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
        ...
        <div className={styles.left}>
          <div className={styles.textb1left}>
            <p className={styles.textb1}>
              BƯỚC 1: TẢI APP PC365 NHÂN VIÊN TẠI ĐÂY
            </p>
          </div>
      ...
      <div className={styles.checknext}></div>
    </div>
  );
};
