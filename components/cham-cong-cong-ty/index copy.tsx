...
import ExportImg from "../cap-nhap-khuon-mat/resizeImg";
...
export default function ChamCongCongTyComponent() {
    ...
    //             // for (var i = 0; i < img.landmark.length; i++) {
    //             await myWorker.postMessage(img.landmark[0]);
    //             let imgUrl = await ExportImg(img.url, img.landmark[0].box);
