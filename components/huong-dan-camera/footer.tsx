                    ...
                    <div className={styles.content}>
                        <div className={styles.desc}>
                            <div className={styles.fl}>
                                <span>
                                    Ngày nay ứng dụng máy chấm công nhận diện
                                    khuôn mặt trở thành một xu hướng thị trường
                                    đang phát triển mạnh mẽ. So với các hình
                                    thức chấm công truyền thống như ghi chép,
                                    vân tay, …, chấm công bằng nhận diện khuôn
                                    mặt đại diện cho một sự tiến bộ lớn trong
                                    việc kiểm soát quy trình vào ra và đảm bảo
                                    tính bảo mật cho doanh nghiệp. Tuy nhiên đó
                                    chưa phải là giới hạn cuối cùng, với sự nỗ
                                    lực không ngừng nghỉ của những bộ óc sáng
                                    tạo, đội ngũ hungha365.com đã đưa nền công
                                    nghệ này lên một bước tiến mới đỉnh cao mang
                                    tên "Camera chấm công nhận diện khuôn mặt
                                    AI365". Với sản phẩm công nghệ được đánh giá
                                    là “đi trước thời đại” này, hungha365.com tự
                                    hào là nhà cung cấp giải pháp toàn diện cho
                                    hệ thống quản lý doanh nghiệp, hỗ trợ đắc
                                    lực cho doanh nghiệp tối ưu hiệu quả công
                                    tác quản lý công, lương chính xác tuyệt đối.
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className={styles.content}>
                        ...
                        <div className={styles.desc}>
                            ...
                            >
                                <Image
                                    src="/alert/hd1.jpg"
                                    alt="Tại sao nên sử dụng hình thức chấm công nhận diện khuôn mặt?"
                                    preview={false}
                                />
                            </div>
                            <div
                            ...
                            >
                                ...
                                >
                                    Tại sao nên sử dụng hình thức chấm công nhận
                                    diện khuôn mặt?
                                </p>
                            </div>
                            <div className={styles.fl}>
                        ...
                        <div className={styles.desc}>
                            ...
                            >
                                ...
                                >
                                    Camera AI365 được xây dựng và phát triển bởi
                                    hungha365
                                </p>
                            </div>
                            <div className={styles.fl}>
                            ...
                            >
                                <Image
                                    src="/alert/hd3.jpg"
                                    alt="Camera AI365 giúp tối ưu quy trình chấm công"
                                    preview={false}
                                />
                            </div>
                            <div
                            ...
                            >
                                ...
                                >
                                    Camera AI365 giúp tối ưu quy trình chấm công
                                </p>
                            </div>
                            <div className={styles.fl}>
                                <span>
                        ...
                        <div className={styles.desc}>
                            ...
                            >
                                ...
                                >
                                    Phần cài đặt wifi trong mục chấm công
                                </p>
                            </div>
                            <div className={styles.fl}>
                                <span>
                            ...
                            >
                                ...
                                >
                                    Nhập địa chỉ IP vào hộp thông tin thích hợp
                                </p>
                            </div>
                            <div className={styles.fl}>
                                <span>
                                    ...
                                    cài đặt wifi thành công cho tiện ích chấm
                            ...
                            >
                                ...
                                >
                                    Tải ứng dụng, phần mềm hỗ trợ công cụ chấm
                                    công
                                </p>
                            </div>
                            <div className={styles.fl}>
                        ...
                        <div className={styles.desc}>
                            ...
                            >
                                ...
                                >
                                    Hungha365 luôn đảm bảo sản phẩm đạt hiệu quả
                                    tuyệt đối
                                </p>
                            </div>
                            <div className={styles.fl}>
