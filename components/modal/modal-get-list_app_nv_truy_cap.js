...
export default function ModalViewAppAccess({setOpen}) {
                     ...
                     {show === 'quan-ly-nhan-su' && (
                        <>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Chat365'} img={'chat_blue.png'} />
                           </Col>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Tính lương'} img={'tinh_luong_blue.png'} />
                           </Col>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Quản trị nhân sự'} img={'quan_tri-ns_blue.png'} />
                           </Col>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Chấm công'} img={'cham_cong_blue.png'} />
                           </Col>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Phần mềm CRM'} img={'crm_blue.png'} />
                           </Col>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Văn thư lưu trữ'} img={'van_thu_blue.png'} />
                           </Col>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Quản lý tài sản'} img={'ql_tai_san_blue.png'} />
                           </Col>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Phần mềm giao việc'} img={'giao_viec_blue.png'} />
                           </Col>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Quản lý KPI'} img={'kpi_blue.png'} />
                           </Col>
                           <Col xxl={12} sm={24} md={12} xl={12} xs={24} lg={12}>
                              <SelectApp app_name={'Đánh giá năng lực nhân viên'} img={'danh_gia_nl_blue.png'} />
                           </Col>
                        </>
                     )}
                  </Row>
