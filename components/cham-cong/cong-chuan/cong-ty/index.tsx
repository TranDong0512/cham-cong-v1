...
export default function CongchuanCty({ listCompanyWorkdays }) {
              ...
              <Card style={{ padding: "20px 10px", fontSize: "16px" }}>
                ...
                <Form.Item>
                  <Button
                    ...
                    htmlType="submit"
                    onClick={() => {
                      if (!form.getFieldValue("num_days")) {
                        alert("Số ngày công không được để trống!");
                        setModalXacNhan(false);
                      }
                      if (form.getFieldValue("num_days") < 0) {
                        setModalXacNhan(false);
                      }
                      if (
                        form.getFieldValue("num_days") &&
                        form.getFieldValue("num_days") > 0
                      ) {
