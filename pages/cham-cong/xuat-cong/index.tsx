              ...
              <Col xl={4} lg={4} md={5} sm={7} xs={12}>
                <ExportExcel
                  ...
                  columns={[
                    ...
                    { header: "Cộng công", key: "col10", width: 9 },
                    { header: "Cộng tiền", key: "col10", width: 9 },
                  ...
                  data={
                    data
                      ? data?.map((item) => [
                        ...
                        item?.late || 0,
                        item?.early || 0,
                        `${item?.num_to_calculate || 0} VNĐ`,
                        item?.num_to_money || 0,
                        item?.money_per_hour || 0,
                        item?.cong_xn_them || 0,
                        item?.tien_xn_them || item?.tientheogio_xn_them || 0,
                        item?.phat_tien_muon || 0,
                        item?.phat_cong_muon || 0,
                        item?.phat_cong_khac || 0,
                        ...item?.lst_time?.map((i) => {
