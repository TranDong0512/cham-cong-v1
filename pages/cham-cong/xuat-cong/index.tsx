              ...
              <Col xl={4} lg={4} md={5} sm={7} xs={12}>
                <ExportExcel
                  ...
                  columns={[
                    ...
                    { header: "Công (công)", key: "col8", width: 15 },
                    { header: "Tiền (VNĐ)", key: "col9", width: 20 },
                    { header: "Tiền theo giờ (VNĐ)", key: "col10", width: 15 },
                    { header: "Phụ cấp ca (VNĐ)", key: "col10", width: 15 },
                    { header: "Cộng công (công)", key: "col11", width: 15 },
                    { header: "Cộng tiền (VNĐ)", key: "col12", width: 15 },
                    {
                      header: "Chi tiết ",
                      key: "col16",
                      width: 10,
                  ...
                  data={
                    data
                      ? data?.map((item) => [
                        ...
                        Number(item?.hour_real) || 0,
                        item?.late || 0,
                        item?.early || 0,
                        item?.num_to_calculate || 0,
                        item?.num_to_money || 0,
                        item?.money_per_hour || 0,
                        item?.money_allowances || 0,
                        item?.cong_xn_them || 0,
