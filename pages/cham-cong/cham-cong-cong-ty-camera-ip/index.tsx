...
export default function ChamCongCongTy() {
  ...
  const sendDataCheckin = async (data, imgSrc) => {
    try {
      const time = new Date()
      ...
      try {
        ...
        if (
          ...
          if (resdata?.result) {
            ...
            //  thành công điểm danh tự động nếu shift === 1
            if (resdata?.shift?.length <= 1) {
            ...
            // nếu không thì chấm công thủ công
            else {
              setModalDetail(true)
            }
          } else {
  ...
  const capture = useCallback(async () => {
    if (ip && lat && long) {
      ...
      const cameraImage: any = document.getElementById('video')
      const canvas = document.createElement('canvas')
      canvas.width = cameraImage.offsetWidth
      canvas.height = cameraImage.offsetHeight
      ...
      if (!resp?.predicted_label) {
        ...
        if (emotionState) {
          ...
          if (emotionScoreCaptured > emotionCaptureThisPoint?.avg_pass_score) {
        ...
        <div
          ...
          <div
            ...
            <img
              ...
              src='https://192.168.1.19:2605/video'
              alt='camera-ip-http'
              id='video'></img>
            <div
        ...
        <div
          ...
          <div className={styles.btnWrapper}>
            ...
            <Button
              ...
              <p style={{ color: '#fff', fontSize: '16px', fontWeight: '400' }}>
                Không phải tôi
              </p>
            </Button>
          </div>
