        ...
        <div className={styles.information}>
          <div>
            <h3 className={styles.h3}>
              Danh sách nhóm hưởng hoa hồng lợi nhuận
            </h3>
            <p className={styles.p_style}>
              Quản lý theo dõi nhóm nhân viên hoa hồng lợi nhuận
            </p>
          </div>
          <div>
          ...
          <div className={styles.modalRecipe_body}>
            <div className={styles.format}>
              ...
              <div className={styles.flex}>
                ...
                <p className={styles.p_edit}>Tổng doanh thu (VNĐ)</p>
              </div>
              <label className={styles.p_edit}>Chu kỳ</label>
